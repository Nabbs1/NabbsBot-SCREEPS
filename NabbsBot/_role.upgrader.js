var roleUpgrader = {
	...
	run: function (creep) {
		...
		// creep.suicide()
		if (creepsHomeRoom && creepsHomeRoom != creep.room.name && creep.memory.working === false) {
			creep.harvestEnergy();
		} else if (creepsHomeRoom && creepsHomeRoom != creep.room.name && creep.memory.working === true) {
