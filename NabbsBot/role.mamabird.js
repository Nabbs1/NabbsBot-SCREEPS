			...
			if (creep.memory.working) {
				var enemy = creep.room.find(FIND_HOSTILE_CREEPS, {
					filter: function (object) {
						return (
							object.getActiveBodyparts(ATTACK) > 0 || object.getActiveBodyparts(RANGED_ATTACK) > 0 || object.getActiveBodyparts(HEAL) > 0
						);
					},
				});
...
function randGreeting(sayThis) {
	var greetings = [sayThis, 'Hello!', 'Howdy', 'Sup', 'Ahoy', 'Hiya!', 'Boop', 'Peep', 'Be Chill', 'Super', 'Uh Oh', 'RUN', 'Be nice', 'Welcome'];
